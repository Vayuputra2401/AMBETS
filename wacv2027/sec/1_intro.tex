...
assigns every token to one of $K$ clinically labeled experts $\{$Background, Necrotic core, Edema,
Enhancing tumor$\}$. The routing distribution is a per-region, concept-labeled map computed in one
