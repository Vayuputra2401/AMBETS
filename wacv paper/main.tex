...
$0.94$ and, on an identical deletion/insertion protocol, a deletion AUC of $0.82$--$0.87$
for edema and enhancing tumor---measured identically over ground-truth and predicted
regions---versus $\le 0.66$ for gradient saliency and $\le 0.40$ for Grad-CAM. Ablations confirm that concept alignment is \emph{learned} (it collapses without
...
variance). \todo{Provisional 40-case comparison---to be refreshed to the full 168-case run
with Integrated Gradients and Occlusion baselines, and bootstrap CIs.}}
\label{tab:faith}
\begin{tabular}{llccc}
\toprule
