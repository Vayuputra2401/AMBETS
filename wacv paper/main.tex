...
loss), while the routing aligns robustly even without the warm-up phase. CCR is the first method
...
by-product of segmentation---exactly the temporal signal in Fig.~\ref{fig:curve}. A4 tells the
